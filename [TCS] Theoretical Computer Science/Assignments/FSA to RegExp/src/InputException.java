...
class InputFileMalformedException extends InputException {
    public InputFileMalformedException() {
        super("E0: Input file is malformed");
    }
}

class NondeterministicFSAException extends InputException {
    public NondeterministicFSAException() {
        super("E5: FSA is nondeterministic");
    }
}
